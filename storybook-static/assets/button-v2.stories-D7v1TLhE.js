import{n as e}from"./chunk-DnJy8xQt.js";import{J as t,Q as n,U as r,W as i}from"./iframe-Ck-CNuiI.js";import{n as a,t as o}from"./button-v2-B9yf6A8I.js";var s,c,l,u,d,f,p,m,h,g,_;e((()=>{r(),a(),s=t(`<div style=display:flex;gap:12px;align-items:center;flex-wrap:wrap>`),c=t(`<div style=display:grid;gap:12px>`),l=t(`<div style=display:grid;gap:8px><div style=font-size:12px;color:var(--text-weak);text-transform:capitalize></div><div style=display:flex;gap:8px;flex-wrap:wrap>`),u=`### Overview
...
`,d={title:`UI V2/Button`,id:`components-button-v2`,component:o,tags:[`autodocs`],parameters:{frameHeight:`240px`,frameBackground:`#fff`,docs:{description:{component:u}}},args:{children:`Button`,variant:`neutral`,size:`normal`},argTypes:{icon:{control:`text`},variant:{control:`select`,options:[`neutral`,`contrast`,`ghost`,`notify-highlight`]},size:{control:`select`,options:[`normal`,`large`]}}},f={},p={render:()=>(()=>{var e=s();return i(e,n(o,{variant:`neutral`,children:`Neutral`}),null),i(e,n(o,{variant:`contrast`,children:`Contrast`}),null),i(e,n(o,{variant:`ghost`,children:`Ghost`}),null),i(e,n(o,{variant:`notify-highlight`,children:`Notify highlight`}),null),e})()},m={render:()=>(()=>{var e=s();return i(e,n(o,{size:`small`,variant:`neutral`,children:`Small`}),null),i(e,n(o,{size:`normal`,variant:`neutral`,children:`Normal`}),null),i(e,n(o,{size:`large`,variant:`neutral`,children:`Large`}),null),e})()},h={render:()=>(()=>{var e=s();return i(e,n(o,{variant:`neutral`,size:`normal`,icon:`plus`,children:`Normal`}),null),i(e,n(o,{variant:`contrast`,size:`large`,icon:`plus`,children:`Large`}),null),e})()},g={render:()=>{let e=[`neutral`,`contrast`,`ghost`,`notify-highlight`],t=[`default`,`hover`,`pressed`,`focus`,`disabled`],r=e=>e.charAt(0).toUpperCase()+e.slice(1);return(()=>{var a=c();return i(a,()=>e.map(e=>(()=>{var a=l(),s=a.firstChild,c=s.nextSibling;return i(s,e),i(c,()=>t.map(t=>n(o,{variant:e,"data-state":t===`default`?void 0:t,disabled:t===`disabled`,get children(){return r(t)}}))),a})())),a})()}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{}`,...f.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    display: "flex",
    gap: "12px",
    "align-items": "center",
