import{n as e}from"./chunk-DnJy8xQt.js";import{G as t,W as n,X as r,rt as i}from"./iframe-hOlr1WQH.js";import{n as a,t as o}from"./button-v2-CyFpZw3H.js";var s,c,l,u,d,f,p,m,h,g,_;e((()=>{n(),a(),s=r(`<div style=display:flex;gap:12px;align-items:center;flex-wrap:wrap>`),c=r(`<div style=display:grid;gap:12px>`),l=r(`<div style=display:grid;gap:8px><div style=font-size:12px;color:var(--text-weak);text-transform:capitalize></div><div style=display:flex;gap:8px;flex-wrap:wrap>`),u=`### Overview
