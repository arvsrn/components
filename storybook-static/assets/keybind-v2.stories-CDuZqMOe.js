import{n as e}from"./chunk-DnJy8xQt.js";import{G as t,W as n,X as r,rt as i}from"./iframe-hOlr1WQH.js";import{n as a,t as o}from"./keybind-v2-C5NxGshz.js";var s,c,l,u,d,f,p,m,h;e((()=>{n(),a(),s=r(`<div style=display:flex;gap:24px;align-items:center>`),c=r(`<div style=display:flex;flex-direction:column;gap:16px><div style=display:flex;gap:24px;align-items:center><span style=font-size:11px;color:#808080;width:50px>Neutral</span></div><div style=display:flex;gap:24px;align-items:center><span style=font-size:11px;color:#808080;width:50px>Ghost`),l=`### Overview
